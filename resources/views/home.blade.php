...
<div class="container">
      ...
      <section class="jumbotron text-center" style="margin-bottom: 0; border-bottom-left-radius: 0; border-bottom-right-radius: 0;">
        <div class="container">
          ...
          <p class="lead text-muted">Agrega con el boton tus colmenas para poder acceder a ellas facilmente. Podras visualizar la actividad de sus sensores y controlar cuando cosechar. Es importante cargar los datos bien!</p>
          <p>
